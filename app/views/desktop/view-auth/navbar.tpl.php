...
<header>
  ...
  <nav>
    <ul id="nav-list">
      ...
      <?php else : ?>
      <li class="nav-li nav-show <?=$navlink==='signin'? 'nav-active' : 'nav-deactive' ?>">
        <a class="nav-link" href="/auth/signin">Accedi</a>
      </li>
      <li class="nav-li nav-show <?=$navlink==='signup'? 'nav-active' : 'nav-deactive' ?>">
      ...
      <li class="nav-li nav-user nav-hide nav-deactive">
